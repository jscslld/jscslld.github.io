...
export const Educations = () => {
    return (
        <div className="mb-3">
            ...
            <ul className="list-disc list-inside space-y-4 leading-relaxed text-sm/6">
                {[
                    ['2024.09 - present', 'Nanjing University', 'Master’s Degree Candidate in Computer Technology'],
                    ...
                    <li key={year + school} className="flex items-start gap-4">
                        <span className="w-36 flex-shrink-0 text-primary font-semibold">{year}</span>
                        <div className="flex flex-col flex-1">
                            <span className="font-semibold">
                                {school}
                                {ranking && (
                                    <span className="ml-2 text-xs font-normal text-default-400">({ranking})</span>
                                )}
                            </span>
